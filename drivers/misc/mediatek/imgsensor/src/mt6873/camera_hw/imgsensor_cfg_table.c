...
#if defined (CONFIG_MTK_CAM_PD2080)
...
#elif defined (CONFIG_MTK_CAM_PD2048)
struct IMGSENSOR_HW_CFG imgsensor_custom_config[] = {
	{
		IMGSENSOR_SENSOR_IDX_MAIN,
		IMGSENSOR_I2C_DEV_0,
...
#endif
#if defined(S5KGH1SM24_MIPI_RAW)
{
   SENSOR_DRVNAME_S5KGH1SM24_MIPI_RAW,
   {
   {RST, Vol_Low, 1},
   {DOVDD, Vol_1800, 1},
   {AVDD, Vol_2800, 1},
...
#endif
#if defined(GC02M1BV1_MIPI_MONO)
	{
		SENSOR_DRVNAME_GC02M1BV1_MIPI_MONO,
		{
			{RST, Vol_Low, 1},
			{DOVDD, Vol_1800, 3},
			{AVDD, Vol_2800, 4},		
...
#endif
#if defined(HI846PD2048_MIPI_RAW)
		{
			SENSOR_DRVNAME_HI846PD2048_MIPI_RAW,
			{
				{RST, Vol_Low, 1},
				{AVDD, Vol_2800, 1},
				{DVDD, Vol_1200, 1},
...
#endif
#if defined(HI846SUB2_MIPI_RAW)
		{
			SENSOR_DRVNAME_HI846SUB2_MIPI_RAW,
			{
				{RST, Vol_Low, 1},
				{AVDD, Vol_2800, 1},
				{DVDD, Vol_1200, 1},
