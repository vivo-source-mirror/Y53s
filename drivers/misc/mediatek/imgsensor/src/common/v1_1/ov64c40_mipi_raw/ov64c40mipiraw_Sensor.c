...
extern int ov64c40_otp_read(void);
extern otp_error_code_t OV64C40_OTP_ERROR_CODE;
MUINT32  sn_inf_main_ov64c40[13];  /*0 flag   1-12 data*/
MUINT32  crosstalk_main_ov64c40[299]; 
MUINT32  material_inf_main_ov64c40[4]; 
MUINT32  af_calib_inf_main_ov64c40[6];   
...
static kal_uint16 addr_data_pair_capture[] = {  // 9216x6912
0x3422, 0x00,
0x3604, 0x70,
0x3605, 0x0e,
0x3615, 0xa7,
...
static kal_uint16 addr_data_pair_custom2[] = { // 4608x3456 
0x3422, 0x80,
0x3604, 0x72,
0x3605, 0x0e,
0x3615, 0x55,
...
static kal_uint16 addr_data_pair_custom3[] = { // 3840x2160 
0x3422, 0x80,
0x3604, 0x72,
0x3605, 0x0e,
0x3615, 0x55,
...
static void sensor_init(void)
{
	...
	for(i = 0; i<288; i++){
    write_cmos_sensor_16_8(0x5a40 + i, crosstalk_main_ov64c40[i+1]); 
    }
	printk("end \n");				  
}	/*	sensor_init  */
		...
		do {
			*sensor_id = return_sensor_id();
			...
			if ( *sensor_id == imgsensor_info.sensor_id) {
				...
				vivo_otp_read_when_power_on = ov64c40_otp_read();
				pr_debug("read eeprom ---vivo_otp_read_when_power_on = %d,OV64C40_OTP_ERROR_CODE=%d\n", vivo_otp_read_when_power_on, OV64C40_OTP_ERROR_CODE);
				/*vivo lxd add end*/
				return ERROR_NONE;
			}
...
/*
    ...
    */
	...
	case SENSOR_FEATURE_GET_CUSTOM_INFO:
	    printk("SENSOR_FEATURE_GET_CUSTOM_INFO information type:%lld  OV64C40_OTP_ERROR_CODE:%d \n", *feature_data,OV64C40_OTP_ERROR_CODE);
		switch (*feature_data) {
			...
			if (*feature_para_len >= sizeof(MUINT32)*13 + 2) {
			    *(MUINT32 *)(uintptr_t)(*(feature_data+1)) = OV64C40_OTP_ERROR_CODE;//otp_state
				memcpy( feature_data+2, sn_inf_main_ov64c40, sizeof(MUINT32)*13); 
				memcpy( feature_data+10, material_inf_main_ov64c40, sizeof(MUINT32)*4); 
				memcpy( feature_data+12, af_calib_inf_main_ov64c40, sizeof(MUINT32)*6); 
				#if 0
						for (i = 0 ; i<12 ; i++ ){
						printk("sn_inf_main_ov64c40[%d]= 0x%x\n", i, sn_inf_main_ov64c40[i]);
						}
				#endif
			}
				break;
...
UINT32 OV64C40_MIPI_RAW_SensorInit(
