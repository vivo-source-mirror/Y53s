...
static struct imgsensor_info_struct imgsensor_info = {
	...
	.pre = {
		...
		.mipi_pixel_rate = 691600000,  /////644800000
		.max_framerate = 300,
	},
...
static kal_uint16 addr_data_pair_preview[] = {
	...
	0x030C, 0x0000,
	0x030E, 0x0004,
	0x0310, 0x0085, /////0085-691600000 007C-644800000
	0x0312, 0x0000,
	0x602A, 0x68D0,
	0x6F12, 0x9600,
	0x602A, 0x720E,
	...
	0x0350, 0x0008,
	0x0352, 0x0008,
	0x0340, 0x0E20, ////0E10-3600 0E20-3616
	0x0342, 0x1CA0, ////1CC0-7360 1CA0-7328
	0x0380, 0x0002,
	0x0382, 0x0002,
	0x0384, 0x0002,
	0x0386, 0x0002,
				  ...
				  UINT8 *feature_para, UINT32 *feature_para_len)
{
	...
	case SENSOR_FEATURE_GET_OFFSET_TO_START_OF_EXPOSURE:
		*(MUINT32 *)(uintptr_t)(*(feature_data + 1)) = 3222000;/*ITS test_sensor_fusion */
		break;
