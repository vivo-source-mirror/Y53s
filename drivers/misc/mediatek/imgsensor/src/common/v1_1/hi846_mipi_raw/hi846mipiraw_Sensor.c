...
MUINT32  material_inf_main_hi846[4];  
MUINT32  af_calib_inf_main2_hi846[6]; 
			...
			do {
				*sensor_id = return_sensor_id();
				if (*sensor_id == imgsensor_info.sensor_id) {				
					...
					PK_DBG("cfx_add:end read eeprom ---vivo_main3_otp_read_when_power_on = %d,MAIN3_OTP_ERROR_CODE_HI846 =%d\n", vivo_main3_otp_read_when_power_on,MAIN3_OTP_ERROR_CODE_HI846);
					/*vivo caofeixiang add end*/
					return ERROR_NONE;
				}	
				  ...
				  UINT8 *feature_para, UINT32 *feature_para_len)
{
	...
	(struct SENSOR_WINSIZE_INFO_STRUCT *) (uintptr_t) (*(feature_data + 1));
        ...
        case SENSOR_FEATURE_GET_CUSTOM_INFO:
		    PK_DBG("SENSOR_FEATURE_GET_CUSTOM_INFO information type:%lld  MAIN3_OTP_ERROR_CODE_HI846:%d \n", *feature_data,MAIN3_OTP_ERROR_CODE_HI846);
			switch (*feature_data) {
				...
				if (*feature_para_len >= sizeof(MUINT32)*13 + 2) {
				    *(MUINT32 *)(uintptr_t)(*(feature_data+1)) = MAIN3_OTP_ERROR_CODE_HI846;//otp_state
				    ...
				    memcpy( feature_data+10, material_inf_main_hi846, sizeof(MUINT32)*4); 
					memcpy( feature_data+12, af_calib_inf_main2_hi846, sizeof(MUINT32)*6); 
					#if 0
							for (i = 0 ; i<12 ; i++ ){
...
UINT32 HI846_MIPI_RAW_SensorInit(
