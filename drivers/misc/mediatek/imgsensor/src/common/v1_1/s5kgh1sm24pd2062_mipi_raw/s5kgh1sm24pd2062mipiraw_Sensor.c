 ...
 * Filename:
 * ---------
 *	 s5kgh1sm24pd2062mipiraw_Sensor.c
 *
 * Project:
 * --------
 *	 ALPS
...
//#include "s5kgh1sm24pd2062mipiraw_freq.h"
...
static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = S5KGH1SM24PD2062_SENSOR_ID,
	...
	.custom2 = { /* 16:11 3984*2740 @ 30fps 11M pdaf*/
		.pclk =1543000000,
		.linelength = 15036,
		.framelength = 3422,
		.startx =0,
...
static struct SENSOR_WINSIZE_INFO_STRUCT imgsensor_winsize_info[10] = {  
	...
	{ 7968, 5480,	0,	  0,	7968, 5480, 3984, 2740,	0000, 0000,	3984,  2740,	  0,	0, 	3984,  2740}, /*custom2*/
	...
	{ 7968, 5480,	336,	4,	7296, 5472, 3648, 2736,	0000, 0000,	3648,  2736,	  0,	0, 	3648,  2736}, /*custom5*/
};
...
{  
  ...
  // Peview mode setting  3984 X 2740   496 X 2720  11M
   ...
   {0x02, 0x0A,   0x00,   0x08, 0x40, 0x00,
    0x00, 0x2B, 0x1220, 0x0DA0, 0x01, 0x00, 0x0000, 0x0000,
    0x01, 0x30, 0x0258, 0x0870, 0x03, 0x00, 0x0000, 0x0000},
...
extern otp_error_code_t S5KGH1SM24PD2062_OTP_ERROR_CODE;
MUINT32  sn_inf_sub_s5kgh1sm24pd2062[13];  /*0 flag   1-12 data*/
MUINT32  material_inf_sub_s5kgh1sm24pd2062[4];  
	...
	case SENSOR_FEATURE_GET_CUSTOM_INFO:
		...
		switch (*feature_data) {
			...
			if (*feature_para_len >= sizeof(MUINT32)*13 + 2) {
			    *(MUINT32 *)(uintptr_t)(*(feature_data+1)) = S5KGH1SM24PD2062_OTP_ERROR_CODE;//otp_state
				memcpy( feature_data+2, sn_inf_sub_s5kgh1sm24pd2062, sizeof(MUINT32)*13); 
				memcpy( feature_data+10, material_inf_sub_s5kgh1sm24pd2062, sizeof(MUINT32)*4); 
				#if 0
						for (i = 0 ; i<12 ; i++ ){
						printk("sn_inf_sub_s5kgh1sm24pd2062[%d]= 0x%x\n", i, sn_inf_sub_s5kgh1sm24pd2062[i]);
						}
				#endif
			}
				break;
...
UINT32 S5KGH1SM24PD2062_MIPI_RAW_SensorInit(
