 ...
 * Filename:
 * ---------
 *	 s5kgw3sp13pd2062mipiraw_Sensor.c
 *
 * Project:
 * --------
 *	 ALPS
...
#include "s5kgw3sp13pd2062mipiraw_freq.h"
...
static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = S5KGW3SP13PD2062_SENSOR_ID,
...
static struct SENSOR_WINSIZE_INFO_STRUCT imgsensor_winsize_info[10] = {  
	...
	{9216, 6912,  0,  0, 9216, 6912, 9216, 6912, 0, 0, 9216, 6912, 0, 0, 9216, 6912}, /* sw remosiac capture */
	...
	{9216, 6912,  0,  0, 9216, 6912, 4608, 3456, 0, 0, 4608, 3456, 0, 0, 4608, 3456}, /*custom5*/
};
...
extern otp_error_code_t S5KGW3SP13PD2062_OTP_ERROR_CODE;
MUINT32  sn_inf_main_s5kgw3sp13pd2062[13];  /*0 flag   1-12 data*/
MUINT32  material_inf_main_s5kgw3sp13pd2062[4];  
	...
	case SENSOR_FEATURE_GET_CUSTOM_INFO:
		...
		switch (*feature_data) {
			...
			if (*feature_para_len >= sizeof(MUINT32)*13 + 2) {
			    *(MUINT32 *)(uintptr_t)(*(feature_data+1)) = S5KGW3SP13PD2062_OTP_ERROR_CODE;//otp_state
				memcpy( feature_data+2, sn_inf_main_s5kgw3sp13pd2062, sizeof(MUINT32)*13); 
				memcpy( feature_data+10, material_inf_main_s5kgw3sp13pd2062, sizeof(MUINT32)*4); 
				#if 0
						for (i = 0 ; i<12 ; i++ ){
						printk("sn_inf_main_s5kgw3sp13pd2062[%d]= 0x%x\n", i, sn_inf_main_s5kgw3sp13pd2062[i]);
						}
				#endif
			}
				break;
...
UINT32 S5KGW3SP13PD2062_MIPI_RAW_SensorInit(
