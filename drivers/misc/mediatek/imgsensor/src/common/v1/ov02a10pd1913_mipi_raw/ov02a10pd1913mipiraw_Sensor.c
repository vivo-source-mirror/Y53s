...
#include "ov02a10pd1913mipiraw_Sensor.h"
...
static struct imgsensor_info_struct imgsensor_info = {
	...
	.sensor_id = OV02A10PD1913_SENSOR_ID,
 ...
 ********************************************************/
	...
	case IMAGE_NORMAL:
		//.sensor_output_dataformat = SENSOR_OUTPUT_FORMAT_RAW_B,
		write_cmos_sensor_8_8(0xfd, 0x01);
		write_cmos_sensor_8_8(0x3f, 0x00);
		write_cmos_sensor_8_8(0x01, 0x01);
	break;
	...
	case IMAGE_H_MIRROR:
		...
		write_cmos_sensor_8_8(0xfd, 0x01);
		write_cmos_sensor_8_8(0x3f, 0x01);
		write_cmos_sensor_8_8(0x01, 0x01);
	break;
	...
	case IMAGE_V_MIRROR:
		...
		write_cmos_sensor_8_8(0xfd, 0x01);
		write_cmos_sensor_8_8(0x3f, 0x02);
		write_cmos_sensor_8_8(0x01, 0x01);
	break;
	...
	case IMAGE_HV_MIRROR: 
		...
		write_cmos_sensor_8_8(0xfd, 0x01);
		write_cmos_sensor_8_8(0x3f, 0x03);
		write_cmos_sensor_8_8(0x01, 0x01);
	break;
