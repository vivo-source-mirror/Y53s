...
extern MUINT32  material_inf_sub_s5k4h7yx[4];  /*0 flag   1-12 data*/
...
int S5K4H7YX_otp_read(void)
{
	...
	if (check_if_group_valid == 0x01) //all the data is valid
	{
		...
		/****material info start****/
			material_inf_sub_s5k4h7yx[0] = (MUINT32)vivo_otp_data[0x0F];
			material_inf_sub_s5k4h7yx[1] = (MUINT32)vivo_otp_data[0x10];
			material_inf_sub_s5k4h7yx[2] = (MUINT32)vivo_otp_data[0x11];
			material_inf_sub_s5k4h7yx[3] = (MUINT32)vivo_otp_data[0x12];
			LOG_INF("material_inf_sub_s5k4h7yx[0] = 0x%x, material_inf_sub_s5k4h7yx[1] = 0x%x, material_inf_sub_s5k4h7yx[2] = 0x%x,material_inf_sub_s5k4h7yx[3] = 0x%x\n",
				material_inf_sub_s5k4h7yx[0]  , material_inf_sub_s5k4h7yx[1],  material_inf_sub_s5k4h7yx[2], material_inf_sub_s5k4h7yx[3]);
		/****material info end****/
