...
static struct imgsensor_info_struct imgsensor_info = {
	...
	.hs_video = { /*hs_video 120fps*/
		...
		.mipi_data_lp2hs_settle_dc = 85,
		.mipi_pixel_rate = 478400000, //1848
		.max_framerate = 1200,
		},
...
static struct SENSOR_WINSIZE_INFO_STRUCT imgsensor_winsize_info[10] = {  
	...
	{ 4000, 3000,	80,	420,   3840, 2160, 1280,  720, 0000, 0000, 1280,  720,	  0,	0, 1280,  720}, /*hight speed video 120fps*/
...
MUINT32  af_calib_inf_main_s5kgm1st[6];
		...
		switch (*feature_data) {
			...
			if (*feature_para_len >= sizeof(MUINT32)*13 + 2) {
			    *(MUINT32 *)(uintptr_t)(*(feature_data+1)) = S5KGM1ST_OTP_ERROR_CODE;//otp_state
				...
				memcpy( feature_data+12, af_calib_inf_main_s5kgm1st, sizeof(MUINT32)*6);
				#if 0
						for (i = 0 ; i<12 ; i++ ){
