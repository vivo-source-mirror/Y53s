...
#include "ov16b10pd1934mipiraw_Sensor.h"

/****************************Modify Following Strings for Debug****************************/
#define PFX "OV16B10PD1934_camera_sensor"
#define LOG_1 LOG_INF("OV16B10PD1934,MIPI 4LANE\n")
...
extern int ov16b10pd1934_otp_read(void);
extern otp_error_code_t OV16B10PD1934_OTP_ERROR_CODE;
extern unsigned char vivo_otp_data[0x0E28]; //[VIVO_OTP_DATA_SIZE]0x0E28;

MUINT32  sn_inf_main_ov16b10pd1934[13];  /*0 flag   1-12 data*/
MUINT32  material_inf_main_ov16b10pd1934[4];
...
static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = OV16B10PD1934_SENSOR_ID,	/* record sensor id defined in Kd_imgsensor.h */
...
{ 4608, 3456, 0, 0, 4608, 3456, 2304, 1728,  216, 344, 1920, 1080, 0, 0, 1920, 1080},/*hs-video*/
{ 4608, 3456, 0, 0, 4608, 3456, 2304, 1728,  24, 20, 2304, 1728, 0, 0, 2304, 1728 },/*slim-video*/
...
/* add from OV16B10PD1934_v1_mirror_on_flip_off_mtk2.0.1.ini */
...
static kal_uint16 gain2reg(const kal_uint16 gain)
{
	...
	return iReg;		/* ov16b10pd1934. sensorGlobalGain */
}
...
static void ov16b_PDGainMap_cali(void)
{
	...
	unsigned char i, buf[98] = {0}, read_buf[98] = {0};
	kal_uint16 addr;
		...
		do {
			*sensor_id = return_sensor_id();
			if (*sensor_id == imgsensor_info.sensor_id) {
				...
				vivo_otp_read_when_power_on = ov16b10pd1934_otp_read();
				LOG_INF("lxd_add:end read eeprom ---vivo_otp_read_when_power_on = %d,OV16B10PD1934_OTP_ERROR_CODE=%d\n", vivo_otp_read_when_power_on, OV16B10PD1934_OTP_ERROR_CODE);
				/*vivo lxd add end*/
                /* vivo tyj add for BlockY = 108/100 Module start */
                /* check OTP ModuleInfo
                **0x0000  Module Info Flag   1:Valid
                **0x0001~0x000D   Module Info
                **0x0003  Year
                **0x0004  Month
                **0x0005  Day
                **0x0006  SensorID
                */
                /* vivo tyj add for BlockY = 108/100 Module end */
				return ERROR_NONE;
			}
			   ...
			   MSDK_SENSOR_CONFIG_STRUCT *sensor_config_data)
{
	...
	sensor_info->PDAF_Support = 2; /* PDAF_SUPPORT_CAMSV*/
				  ...
				  UINT8 *feature_para, UINT32 *feature_para_len)
{
	...
	/*case SENSOR_FEATURE_GET_PDAF_DATA:
		...
		read_ov16b10pd1934_eeprom((kal_uint16 )(*feature_data),(char*)(uintptr_t)(*(feature_data+1)),(kal_uint32)(*(feature_data+2)));
		break;*/
	...
	case SENSOR_FEATURE_GET_PDAF_INFO:
		...
		switch (*feature_data) {
		case MSDK_SCENARIO_ID_CAMERA_CAPTURE_JPEG:
                imgsensor_pd_info.i4BlockNumX = 144;
	...
	case SENSOR_FEATURE_GET_SENSOR_PDAF_CAPACITY:
		...
		/* PDAF capacity enable or not, ov16b10pd1934 only full size support PDAF */
		switch (*feature_data) {
			case MSDK_SCENARIO_ID_CAMERA_CAPTURE_JPEG:
    ...
    */
    case SENSOR_FEATURE_GET_VC_INFO:
		...
		case SENSOR_FEATURE_GET_CUSTOM_INFO:
			#if 1
		    LOG_INF("SENSOR_FEATURE_GET_CUSTOM_INFO information type:%lld  OV16B10PD1934_OTP_ERROR_CODE:%d \n", *feature_data,OV16B10PD1934_OTP_ERROR_CODE);
			switch (*feature_data) {
				...
				if (*feature_para_len >= sizeof(MUINT32)*13 + 2) {
				    *(MUINT32 *)(uintptr_t)(*(feature_data+1)) = OV16B10PD1934_OTP_ERROR_CODE;//otp_state
					memcpy(feature_data+2, sn_inf_main_ov16b10pd1934, sizeof(MUINT32)*13); 
					memcpy( feature_data+10, material_inf_main_ov16b10pd1934, sizeof(MUINT32)*4);
					#if 0
							for (int i = 0 ; i<13 ; i++ ){
							printk("sn_inf_main_ov16b10pd1934[%d]= 0x%x\n", i, sn_inf_main_ov16b10pd1934[i]);
							}
...
UINT32 OV16B10PD1934_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc)
{
