...
#define PFX "GC02M1V1PD2103_camera_sensor"
#define LOG_1 LOG_INF("GC02M1V1PD2103,MIPI 1LANE\n")
/****************************   Modify end    *******************************************/
...
static struct imgsensor_info_struct imgsensor_info = {
	...
	.sensor_id = GC02M1V1PD2103_SENSOR_ID,
...
extern otp_error_code_t GC02M1V1PD2103_OTP_ERROR_CODE;
MUINT32  sn_inf_sub_gc02m1v1pd2103[13];  /*0 flag   1-12 data*/
MUINT32  material_inf_sub_gc02m1v1pd2103[4];  
extern int gc02m1v1pd2103_read_sn_id(void);
...
static kal_uint32 return_sensor_id(void)
{
	...
	if (tmp_id == GC02M1V1PD2103_SENSOR_ID) {
		...
		do {
			*sensor_id = return_sensor_id();
			...
			if (*sensor_id == imgsensor_info.sensor_id) {
				...
				vivo_otp_read_when_power_on = MICRGC02MV1_otp_read();
				pr_debug("read eeprom ---vivo_otp_read_when_power_on = %d,MAIN_F8D1_OTP_ERROR_CODE=%d\n", vivo_otp_read_when_power_on, GC02M1V1PD2103_OTP_ERROR_CODE);
				return ERROR_NONE;
			}
			LOG_INF
				  ...
				  UINT32 *feature_para_len)
{
	...
	case SENSOR_FEATURE_GET_CUSTOM_INFO:
	    printk("SENSOR_FEATURE_GET_CUSTOM_INFO information type:%lld  GC02M1V1PD2103_OTP_ERROR_CODE:%d \n", *feature_data,GC02M1V1PD2103_OTP_ERROR_CODE);
		switch (*feature_data) {
			...
			if (*feature_para_len >= sizeof(MUINT32)*13 + 2) {
			    *(MUINT32 *)(uintptr_t)(*(feature_data+1)) = GC02M1V1PD2103_OTP_ERROR_CODE;//otp_state
				memcpy( feature_data+2, sn_inf_sub_gc02m1v1pd2103, sizeof(MUINT32)*13); 
				memcpy( feature_data+10, material_inf_sub_gc02m1v1pd2103, sizeof(MUINT32)*4); 
			}
				break;
			}
			break;
