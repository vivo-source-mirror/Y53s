...
extern int ov16b10_otp_read(void);
extern otp_error_code_t OV16B10_OTP_ERROR_CODE;
extern unsigned char vivo_otp_data[0x0E28]; //[VIVO_OTP_DATA_SIZE]0x0E28;

MUINT32  sn_inf_main_ov16b10[13];  /*0 flag   1-12 data*/
...
static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = OV16B10_SENSOR_ID,	/* record sensor id defined in Kd_imgsensor.h */
...
/* add from OV16B10_v1_mirror_on_flip_off_mtk2.0.1.ini */
...
static kal_uint16 gain2reg(const kal_uint16 gain)
{
	...
	return iReg;		/* ov16b10. sensorGlobalGain */
}
		...
		do {
			*sensor_id = return_sensor_id();
			if (*sensor_id == imgsensor_info.sensor_id) {
				...
				vivo_otp_read_when_power_on = ov16b10_otp_read();
				LOG_INF("lxd_add:end read eeprom ---vivo_otp_read_when_power_on = %d,OV16B10_OTP_ERROR_CODE=%d\n", vivo_otp_read_when_power_on, OV16B10_OTP_ERROR_CODE);
				/*vivo lxd add end*/
				  ...
				  UINT8 *feature_para, UINT32 *feature_para_len)
{
	...
	/*case SENSOR_FEATURE_GET_PDAF_DATA:
		...
		read_ov16b10_eeprom((kal_uint16 )(*feature_data),(char*)(uintptr_t)(*(feature_data+1)),(kal_uint32)(*(feature_data+2)));
		break;*/
	...
	case SENSOR_FEATURE_GET_SENSOR_PDAF_CAPACITY:
		...
		/* PDAF capacity enable or not, ov16b10 only full size support PDAF */
		switch (*feature_data) {
			case MSDK_SCENARIO_ID_CAMERA_CAPTURE_JPEG:
    ...
    */
    case SENSOR_FEATURE_GET_VC_INFO:
		...
		case SENSOR_FEATURE_GET_CUSTOM_INFO:
			#if 1
		    LOG_INF("SENSOR_FEATURE_GET_CUSTOM_INFO information type:%lld  OV16B10_OTP_ERROR_CODE:%d \n", *feature_data,OV16B10_OTP_ERROR_CODE);
			switch (*feature_data) {
				...
				if (*feature_para_len >= sizeof(MUINT32)*13 + 2) {
				    *(MUINT32 *)(uintptr_t)(*(feature_data+1)) = OV16B10_OTP_ERROR_CODE;//otp_state
					memcpy(feature_data+2, sn_inf_main_ov16b10, sizeof(MUINT32)*13); 
					#if 0
							for (int i = 0 ; i<13 ; i++ ){
							printk("sn_inf_main_ov16b10[%d]= 0x%x\n", i, sn_inf_main_ov16b10[i]);
							}
