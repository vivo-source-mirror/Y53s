 ...
 * Filename:
 * ---------
 *	 HI846PD1934V1_mipi_raw_Sensor.c
 *
 * Project:
 * --------
 *	 ALPS
...
#define PFX "hi846pd1934v1_camera_sensor"
...
static imgsensor_info_struct imgsensor_info = { 
	.sensor_id = HI846PD1934V1_SENSOR_ID,
	...
	.custom1 = {
		...
		.linelength  = 3800,				//record different mode's linelength
		.framelength = 2526,			/*record different mode's framelength*/
		.startx = 592,					//record different mode's startx of grabwindow
		.starty = 444,					//record different mode's starty of grabwindow
...
static struct SENSOR_WINSIZE_INFO_STRUCT imgsensor_winsize_info[10] = {
	...
	{ 3264, 2448, 	0,		0,	 3264, 2448, 3264, 2448, 0, 0, 3264, 2448,  592,  444, 2080, 1560}, // custom1	  
...
extern int vivo_main3_otp_read_v1(void);
int vivo_main3_otp_read_when_power_on_v1;
extern int hi846_read_sn_id_v1(void);
extern otp_error_code_t MAIN3_OTP_ERROR_CODE_HI846PD1934V1;
MUINT32  sn_inf_main3_hi846pd1934v1[13];  /*0 flag   1-12 data*/
MUINT32  material_inf_main3_hi846pd1934v1[4];
...
{    
	...
	while (imgsensor_info.i2c_addr_table[i] != 0xff) {
			...
			do {
			 ...
			 if (0x36514453 == hi846_read_sn_id_v1()) {
					LOG_INF("i2c write id  : 0x%x, sensor id: 0x%x\n", imgsensor.i2c_write_id, *sensor_id);
					sensor_init();
					/*vivo caofeixiang add for CameraEM otp errorcode*/
					LOG_INF("cfx_add:start read eeprom ---vivo_main3_otp_read_when_power_on_v1 = %d\n", vivo_main3_otp_read_when_power_on_v1);
					vivo_main3_otp_read_when_power_on_v1 = vivo_main3_otp_read_v1();
					LOG_INF("cfx_add:end read eeprom ---vivo_main3_otp_read_when_power_on_v1 = %d, MAIN3_OTP_ERROR_CODE_HI846PD1934V1 =%d\n", vivo_main3_otp_read_when_power_on_v1, MAIN3_OTP_ERROR_CODE_HI846PD1934V1);
					/*vivo caofeixiang add end*/
					return ERROR_NONE;
				} else {
				*sensor_id = 0xFFFFFFFF;
...
//    unsigned long long *feature_return_para=(unsigned long long *) feature_para;
	...
	break;
		...
		case SENSOR_FEATURE_GET_CUSTOM_INFO:
		    LOG_INF("SENSOR_FEATURE_GET_CUSTOM_INFO information type:%lld  MAIN3_OTP_ERROR_CODE_HI846PD1934V1:%d \n", *feature_data, MAIN3_OTP_ERROR_CODE_HI846PD1934V1);
			switch (*feature_data) {
			case 0:    //info type: otp state
				...
				if (*feature_para_len >= sizeof(MUINT32)*13 + 2) {
				    *(MUINT32 *)(uintptr_t)(*(feature_data+1)) = MAIN3_OTP_ERROR_CODE_HI846PD1934V1;//otp_state
					memcpy(feature_data+2, sn_inf_main3_hi846pd1934v1, sizeof(MUINT32)*13); 
					memcpy( feature_data+10, material_inf_main3_hi846pd1934v1, sizeof(MUINT32)*4);
					#if 0
							for (i = 0 ; i < 12 ; i++) {
							printk("sn_inf_main3_hi846pd1934v1[%d]= 0x%x\n", i, sn_inf_main3_hi846pd1934v1[i]);
							}
