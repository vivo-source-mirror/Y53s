...
enum OV8856PD1913_VERSION {
	OV8856PD1913R2A,
	OV8856PD1913R1A
};

enum OV8856PD1913_VERSION ov8856pd1913version = OV8856PD1913R1A;
...
static struct imgsensor_info_struct imgsensor_info = {
	...
	.sensor_id = OV8856PD1913_SENSOR_ID,
...
extern int vivo_main3_otp_read_ov8856pd1913(void);
int vivo_main3_otp_read_when_power_on_ov8856pd1913;
extern otp_error_code_t MAIN3_OTP_ERROR_CODE_OV8856PD1913;
MUINT32  sn_inf_main2_ov8856pd1913[13];  /*0 flag   1-12 data*/
...
static kal_uint16 ov8856pd1913_table_write_cmos_sensor(
...
kal_uint16 addr_data_pair_init_ov8856pd1913[] = {
	0x0103, 0x01,
	0x0302, 0x35,
	0x0303, 0x00,
	0x031e, 0x0c,
...
static void sensor_init(void)
{
	pr_debug("v3 E\n");
#if 1	/* MULTI_WRITE */
	ov8856pd1913_table_write_cmos_sensor(addr_data_pair_init_ov8856pd1913,
		    sizeof(addr_data_pair_init_ov8856pd1913) / sizeof(kal_uint16));
#endif
 ...
 *
 *************************************************************************/
kal_uint16 addr_data_pair_preview_ov8856pd1913[] = {
	0x0302,	0x3c,
	0x0303,	0x01,
	0x3501,	0x4c,
	0x3502,	0xe0,
...
#endif
	ov8856pd1913_table_write_cmos_sensor(addr_data_pair_preview_ov8856pd1913,
		sizeof(addr_data_pair_preview_ov8856pd1913) / sizeof(kal_uint16));
 ...
 *
 *************************************************************************/
kal_uint16 addr_data_pair_capture_30fps_ov8856pd1913[] = {
	0x0302, 0x35,
	0x0303, 0x00,
	0x3501, 0x9a,
	0x3502, 0x20,
...
#endif
	if (currefps == 150) {
		ov8856pd1913_table_write_cmos_sensor(
			addr_data_pair_normal_video,
	    sizeof(addr_data_pair_normal_video) / sizeof(kal_uint16));
	} else {
		ov8856pd1913_table_write_cmos_sensor(
			addr_data_pair_capture_30fps_ov8856pd1913,
	    sizeof(addr_data_pair_capture_30fps_ov8856pd1913) / sizeof(kal_uint16));
...
static void normal_video_setting(void)
{
	...
	ov8856pd1913_table_write_cmos_sensor(addr_data_pair_normal_video,
		   sizeof(addr_data_pair_normal_video) / sizeof(kal_uint16));
...
{
	LOG_INF("\n");
	ov8856pd1913_table_write_cmos_sensor(addr_data_pair_hs_video,
...
{
	LOG_INF("\n");
    ov8856pd1913_table_write_cmos_sensor(addr_data_pair_slim_video,
...
{
	LOG_INF("\n");
    ov8856pd1913_table_write_cmos_sensor(addr_data_pair_custom1,
		   ...
		   (read_cmos_sensor(0x300B) << 8) | read_cmos_sensor(0x300C));
			...
			if (*sensor_id == imgsensor_info.sensor_id) {
				//if ((read_cmos_sensor(0x302A)) == 0XB0) {
					...
					printk("i2c write id: 0x%x, sensor id: 0x%x, ver = %d<0=r2a,1=r1a>\n",imgsensor.i2c_write_id,*sensor_id, ov8856pd1913version);
					vivo_main3_otp_read_when_power_on_ov8856pd1913 = vivo_main3_otp_read_ov8856pd1913();
	...
	UINT8 *feature_para, UINT32 *feature_para_len)
{
	...
	case SENSOR_FEATURE_GET_CUSTOM_INFO:
		...
		printk("SENSOR_FEATURE_GET_CUSTOM_INFO information type:%lld  MAIN3_OTP_ERROR_CODE_OV8856pd1913:%d \n", *feature_data,MAIN3_OTP_ERROR_CODE_OV8856PD1913);
			switch (*feature_data) {
				...
				if (*feature_para_len >= sizeof(MUINT32)*13 + 2) {
					*(MUINT32 *)(uintptr_t)(*(feature_data+1)) = MAIN3_OTP_ERROR_CODE_OV8856PD1913;//otp_state
					memcpy( feature_data+2, sn_inf_main2_ov8856pd1913, sizeof(MUINT32)*13); 
					#if 0
						for (i = 0 ; i<12 ; i++ ){
						printk("sn_inf_main2_ov8856pd1913[%d]= 0x%x\n", i, sn_inf_main2_ov8856pd1913[i]);
						}
