...
static struct imgsensor_info_struct imgsensor_info = {
	...
	.custom1 = { /*cpy from preview for dual camera*/
		.pclk =797330000,
		.linelength = 9200,  /////7360-30fps  9200-24fps
		.framelength = 3600,
		.startx =0,
		.starty = 0,
		.grabwindow_width = 4608,
		...
		.mipi_data_lp2hs_settle_dc = 85,
		/*	 following for GetDefaultFramerateByScenario()	*/
		.mipi_pixel_rate = 499200000, ///24fps-520000000 30fps-691600000  24fps-499200000
		.max_framerate = 240,
		},
...
static struct SENSOR_WINSIZE_INFO_STRUCT imgsensor_winsize_info[10] = {  
	...
	{9216, 6912,  0,  0, 9216, 6912, 4608, 3456, 0, 0, 4608, 3456, 0, 0, 4608, 3456}, /* custom2 */
...
static struct SET_PD_BLOCK_INFO_T imgsensor_pd_info =  //4640*3456
{
	...
	.i4BlockNumY = 430,
	.iMirrorFlip = 3,
	.i4Crop = { {16,8}, {0,0}, {16, 440}, {0, 0}, {0, 0}, {16, 8}, {16, 8}, {400, 656}, {16, 440}, {0, 0}},
};
...
static kal_uint16 addr_data_pair_hs_video[] = {
	...
	0x6F12, 0x0000,
	0x6F12, 0x0000,
	0x0D02, 0x0001,   ////tail mode pdaf off
	0x0D04, 0x0002,   ////tail mode pdaf off
	0x0114, 0x0300,   ////tail mode pdaf off
	0x602A, 0x550A,
	0x6F12, 0x1000,
	0x602A, 0x54F6,
	0x6F12, 0x0000,
...
static kal_uint16 addr_data_pair_custom1[] = {
	...
	0x030C, 0x0000,
	0x030E, 0x0004,
	0x0310, 0x0060,  /////0085 - 1729mbps-691600000    0064-1300mbps-520000000  0060-1248mbps-499200000
	0x0312, 0x0000,
	0x602A, 0x68D0,
	0x6F12, 0x9600,
	0x602A, 0x720E,
	...
	0x0352, 0x0008,
	0x0340, 0x0E10,
	0x0342, 0x23F0, /////1CC0-30fps 23F0-24fps
	0x0380, 0x0002,
	0x0382, 0x0002,
	0x0384, 0x0002,
	0x0386, 0x0002,
	...
	enum MSDK_SCENARIO_ID_ENUM scenario_id,	MUINT32 framerate)
{
	...
	PK_DBG("scenario_id = %d, framerate = %d, current sensor mode = %d\n", scenario_id, framerate,
		imgsensor.sensor_mode);

	if(imgsensor.sensor_mode == IMGSENSOR_MODE_CAPTURE && framerate == 240) {
		scenario_id = imgsensor.current_scenario_id;
		PK_DBG("force modify scenario_id to = %d\n", scenario_id);
	}
	switch (scenario_id) {
	case MSDK_SCENARIO_ID_CAMERA_PREVIEW:
