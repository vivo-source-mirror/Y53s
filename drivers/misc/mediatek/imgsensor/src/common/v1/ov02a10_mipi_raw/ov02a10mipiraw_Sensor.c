...
#define LOG_1 LOG_INF("OV02A10,MIPI 4LANE\n")
...
static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = OV02A10_SENSOR_ID,	/* record sensor id defined in Kd_imgsensor.h */
				  ...
				  UINT8 *feature_para, UINT32 *feature_para_len)
{
	...
	case SENSOR_FEATURE_GET_DEFAULT_FRAME_RATE_BY_SCENARIO:
		 ...
		 * read_ov02a10_eeprom((kal_uint16 )(*feature_data),
	...
	case SENSOR_FEATURE_SET_HDR:
		 ...
		 * if(!imgsensor.ihdr_en)
		 * {
		 * write_cmos_sensor_8_8(0x38210, 0x04);
		 * write_cmos_sensor_8_8(0x38360, 0x04);
		 * write_cmos_sensor_8_8(0x38370, 0x01);
		 * write_cmos_sensor_8_8(0x37670, 0x24);
		 * write_cmos_sensor_8_8(0x40290, 0x02);
		 * write_cmos_sensor_8_8(0x372e0, 0x82);
		 * write_cmos_sensor_8_8(0x40010, 0x00);
		 * write_cmos_sensor_8_8(0x37180, 0x10);
		 * }
		 */
		break;
	...
	case SENSOR_FEATURE_GET_TEMPERATURE_VALUE:
        ...
        case SENSOR_FEATURE_GET_CUSTOM_INFO:
            LOG_INF("SENSOR_FEATURE_GET_CUSTOM_INFO information type:%lld\n", *feature_data);
            switch (*feature_data) {
