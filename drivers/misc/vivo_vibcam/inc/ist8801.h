...
#define IST8801_DRIVER_VERSION                "Ver1.04-140226"
/* ********************************************************* */

/* ********************************************************* */
/* property of driver */
/* ********************************************************* */
#define IST8801_DRIVER_NAME                   "ist8801_up"
#define IST8801_DRIVER_NAME_MIDDLE            "ist8801_middle"
#define IST8801_DRIVER_NAME_DOWN              "ist8801_down"
#define IST8801_IRQ_NAME                      "ist8801-irq"
#define IST8801_PATH                          "/dev/ist8801"

#define UP_HOLL_NAME                        "up_hall"
#define DOWN_HOLL_NAME                      "down_hall"
...
*/
#define IST8801_SLAVE_ADDR                    (0x18)
/* ********************************************************* */
...
#define IST8801_VAL_PERSINT_INTCLR            (0x01)
	/*
...
#define IST8801_VAL_INTSRS_SRS_10BIT_0_068mT  (0x00)
#define IST8801_VAL_INTSRS_SRS_10BIT_0_034mT  (0x01)
#define IST8801_VAL_INTSRS_SRS_10BIT_0_017mT  (0x02)
#define IST8801_VAL_INTSRS_SRS_10BIT_0_009mT  (0x03)
#define IST8801_VAL_INTSRS_SRS_10BIT_0_004mT  (0x04)
#define IST8801_VAL_INTSRS_SRS_8BIT_0_272mT   (0x00)
#define IST8801_VAL_INTSRS_SRS_8BIT_0_136mT   (0x01)
#define IST8801_VAL_INTSRS_SRS_8BIT_0_068mT   (0x02)
#define IST8801_VAL_INTSRS_SRS_8BIT_0_036mT   (0x03)
#define IST8801_VAL_INTSRS_SRS_8BIT_0_016mT   (0x04)
	/*
		...
		[2:0]   SRS         : select sensitivity type when IST8801_VAL_OPF_BIT_10
					000     : 0.068 (mT/LSB)
					001     : 0.034 (mT/LSB)
					010     : 0.017 (mT/LSB)
					011     : 0.009 (mT/LSB)
					...
					110     : 0.017 (mT/LSB)
					111     : 0.017 (mT/LSB)
		[2:0]   SRS         : select sensitivity type when IST8801_VAL_OPF_BIT_8
					000     : 0.272 (mT/LSB)
					001     : 0.136 (mT/LSB)
					010     : 0.068 (mT/LSB)
					011     : 0.036 (mT/LSB)
...
#define IST8801_TST_CONNECT_GND               (0x04)
	/*
		[0]     SRST    = 1 : soft reset
	*/
/* --------------------------------------------------------- */
...
#define IST8801_VAL_OPF_FREQ_20HZ             (0x00)
...
#define IST8801_VAL_OPF_EFRD_ON               (0x08)
#define IST8801_VAL_OPF_BIT_8                 (0x02)
#define IST8801_VAL_OPF_BIT_10                (0x00)
#define IST8801_VAL_OPF_HSSON_ON              (0x01)
#define IST8801_VAL_OPF_HSSON_OFF             (0x00)
	/*
...
#define IST8801_REG_MACHINE_RESET             (0x40)
...
/* ioctl command */
/* ********************************************************* */
#define IST8801_IOCTL_BASE                    (0x80)
#define IST8801_IOCTL_SET_ENABLE              _IOW(IST8801_IOCTL_BASE, 0x00, int)
#define IST8801_IOCTL_GET_ENABLE              _IOR(IST8801_IOCTL_BASE, 0x01, int)
#define IST8801_IOCTL_SET_DELAY               _IOW(IST8801_IOCTL_BASE, 0x02, int)
#define IST8801_IOCTL_GET_DELAY               _IOR(IST8801_IOCTL_BASE, 0x03, int)
#define IST8801_IOCTL_SET_CALIBRATION         _IOW(IST8801_IOCTL_BASE, 0x04, int*)
#define IST8801_IOCTL_GET_CALIBRATED_DATA     _IOR(IST8801_IOCTL_BASE, 0x05, int*)
#define IST8801_IOCTL_SET_INTERRUPT           _IOW(IST8801_IOCTL_BASE, 0x06, unsigned int)
#define IST8801_IOCTL_GET_INTERRUPT           _IOR(IST8801_IOCTL_BASE, 0x07, unsigned int*)
#define IST8801_IOCTL_SET_THRESHOLD_HIGH      _IOW(IST8801_IOCTL_BASE, 0x08, unsigned int)
#define IST8801_IOCTL_GET_THRESHOLD_HIGH      _IOR(IST8801_IOCTL_BASE, 0x09, unsigned int*)
#define IST8801_IOCTL_SET_THRESHOLD_LOW       _IOW(IST8801_IOCTL_BASE, 0x0A, unsigned int)
#define IST8801_IOCTL_GET_THRESHOLD_LOW       _IOR(IST8801_IOCTL_BASE, 0x0B, unsigned int*)
#define IST8801_IOCTL_SET_REG                 _IOW(IST8801_IOCTL_BASE, 0x0C, int)
#define IST8801_IOCTL_GET_REG                 _IOR(IST8801_IOCTL_BASE, 0x0D, int)
/* ********************************************************* */
...
/* delay property */
/* ********************************************************* */
#define IST8801_DELAY_MAX                     (200)   /* ms */
#define IST8801_DELAY_MIN                     (20)    /* ms */
#define IST8801_DELAY_FOR_READY               (10)    /* ms */
/* ********************************************************* */
