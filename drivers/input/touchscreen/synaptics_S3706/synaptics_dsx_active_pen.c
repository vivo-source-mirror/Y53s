...
DECLARE_COMPLETION(s3706_apen_remove_complete);
...
exit:
	complete(&s3706_apen_remove_complete);
...
{
	synaptics_3706_rmi4_new_function(&active_pen_module, true);
...
{
	synaptics_3706_rmi4_new_function(&active_pen_module, false);

	wait_for_completion(&s3706_apen_remove_complete);
