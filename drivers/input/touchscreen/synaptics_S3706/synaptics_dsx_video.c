...
DECLARE_COMPLETION(s3706_video_remove_complete);
...
exit:
	complete(&s3706_video_remove_complete);
...
{
	synaptics_3706_rmi4_new_function(&video_module, true);
...
{
	synaptics_3706_rmi4_new_function(&video_module, false);

	wait_for_completion(&s3706_video_remove_complete);
