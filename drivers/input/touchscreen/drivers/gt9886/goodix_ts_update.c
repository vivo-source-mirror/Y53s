...
#if 0
static int __init goodix_fwu_module_V2_init(void)
{
	return goodix_register_ext_module_V2(&goodix_fwu_module_V2);
}

static void __exit goodix_fwu_module_V2_exit(void)
{
	return;
}

module_init(goodix_fwu_module_V2_init);
module_exit(goodix_fwu_module_V2_exit);
