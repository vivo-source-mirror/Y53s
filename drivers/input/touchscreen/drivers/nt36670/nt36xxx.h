...
/*---I2C driver info.---*/
#define NVT_I2C_NAME "NVT-ts-36670"
...
#if WAKEUP_GESTURE
extern const uint16_t nt36670_gesture_key_array[];
#endif
...
#define NVTFLASH_WORK_PROTECT (1)
	...
	extern atomic_t u8_NT36670_flashWorking;
#endif
...
/*---extern structures---*/
extern struct nvt_ts_data *nt36670_ts;

/*---extern functions---*/
extern int32_t NT36670_CTP_I2C_READ(struct i2c_client *client, uint16_t address, uint8_t *buf, uint16_t len);
extern int32_t NT36670_CTP_I2C_WRITE(struct i2c_client *client, uint16_t address, uint8_t *buf, uint16_t len);
extern void nt36670_bootloader_reset(void);
extern void nt36670_sw_reset_idle(void);
extern int32_t nt36670_check_fw_reset_state(RST_COMPLETE_STATE check_reset_state);
extern int32_t nt36670_get_fw_info(void);
extern int32_t nt36670_clear_fw_status(void);
extern int32_t nt36670_check_fw_status(void);
#if NVT_TOUCH_ESD_PROTECT
extern void nvt_esd_check_enable(uint8_t enable);
#endif
extern void nt36670_stop_crc_reboot(void);
