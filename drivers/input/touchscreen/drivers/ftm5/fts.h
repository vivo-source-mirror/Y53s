...
/** @defgroup conf_section	 Driver Configuration Section
  ...
  */
/* **** CODE CONFIGURATION **** */
#define FTS_TS_DRV_NAME		"fts-ftm5"	/* /< driver name */
...
#define Y_AXIS_MAX	2315	/* /< Max Y coordinate of the display */
...
/*
  ...
  */
struct fts_ts_info;
extern char tag_ftm5[8];	/* /< forward the definition of the label used
...
struct fts_ts_info {
	...
	struct mutex gestureMask_mutex_ftm5;	/* /< mutex used to control access on gesture
					 * shared variables */

	ErrorList errors;	/* /< private variable which implement the Error */

	TestToDo tests_ftm5;	/* /< global variable that specify the tests_ftm5 to perform during
