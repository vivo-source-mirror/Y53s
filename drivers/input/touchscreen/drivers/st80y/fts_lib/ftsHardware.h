...
#define FLASH_CX_PAGE_START		30	/* /< starting page which
						 * contain Cx data */
#define FLASH_CX_PAGE_END		30	/* /< last page which contain Cx
						 * data */
#define FLASH_PANEL_PAGE_START		28	/* /< starting page which
						 * contain Panel Init data */
#define FLASH_PANEL_PAGE_END		29	/* /< last page which contain
						 * Panel Init data */
