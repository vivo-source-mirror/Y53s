...
/** @defgroup mp_test Mass Production Test
  ...
  * - ITO test = st80y_production_test_ito() \n
  * - Initialization = st80y_production_test_initialization() \n
  * - Data Test = st80y_production_test_data(),
...
int st80y_production_test_ms_cx_lp(struct fts_ts_info *info, char *path_limits, int stop_on_fail,
			TestToDo *todo);
