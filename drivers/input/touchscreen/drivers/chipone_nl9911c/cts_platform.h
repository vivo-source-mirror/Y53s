...
#define cts_err(fmt, ...)    VTE("[%s] : " fmt, "CTS-error",##__VA_ARGS__)
#define cts_info(fmt, ...)   VTI("[%s] : " fmt, "CTS-info", ##__VA_ARGS__)
#define cts_warn(fmt, ...)   VTI("[%s] : " fmt, "CTS-warn",  ##__VA_ARGS__)
#define cts_dbg(fmt, ...)    VTD("[%s] : " fmt, "CTS-warn",  ##__VA_ARGS__)

*/

#define cts_err(fmt, args...)    VTE("[%s] %s %d: " fmt, "CTS-error", __func__, __LINE__, ##args)
#define cts_info(fmt, args...)   VTI("[%s] %s %d: " fmt, "CTS-info", __func__, __LINE__, ##args)
#define cts_warn(fmt, args...)   VTI("[%s] %s %d: " fmt, "CTS-warn", __func__, __LINE__, ##args)
#define cts_dbg(fmt, args...)    VTD("[%s] %s %d: " fmt, "CTS-warn", __func__, __LINE__, ##args)
...
struct cts_platform_data {
    ...
    #elif defined CONFIG_MTK_SPI
    struct mtk_chip_conf spi_ctrdata;
    #endif

    #ifdef CONFIG_ARCH_BENGAL
    struct spi_geni_qcom_ctrl_data spi_ctrdata;
    #endif  
};
...
extern int cts_init_platform_data(struct cts_platform_data *pdata,
        struct spi_device *spi, struct device_node *dev_node);
#endif
