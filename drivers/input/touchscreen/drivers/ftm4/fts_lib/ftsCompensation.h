...
//CHIP INFO
#define CHIP_INFO_SIZE					139//bytes to read from framebuffer (exclude the signature and the type because already checked during the reading)
