...
#define EVENTID_LAST                        (0xEA+1)
/*add for ear detect*/
#define EVENTID_EAR_DETECT                  0xC1
#define EVENTID_DATA_READ                   0x25
#define EVENTID_PARAM_GET                   0xC2
#define EVENTID_EAR_DEBUG                   0xEA
...
#define FEAT_VR				0x10
/*sunsl
#define FEAT_E_REJECT			0X0100	//edge sunsl compare next
#define FEAT_EDGE_REJECTION		0x20	//pix reject sunsl compare last
#define FEAT_CORNER_REJECTION		0x40
#define FEAT_EDGE_PALM_REJECTION	0x80
 */
#define FEAT_EDGE_PIX_REJECT				0x20
#define FEAT_EDGE_CORNER_REJECTION		0x40
#define FEAT_EDGE_L_REJECTION			0x80
#define FEAT_EDGE_REJECTION				0X0100
