...
#ifdef CONFIG_OF
static const struct of_device_id gt9897_i2c_matchs[] = {
	{.compatible = "goodix,brl-generic",},
	{.compatible = "goodix,gt9897",},
	{},
};
MODULE_DEVICE_TABLE(of, gt9897_i2c_matchs);
#endif

static const struct i2c_device_id gt9897_i2c_id_table[] = {
	{TS_DRIVER_NAME, 0},
	{},
};
MODULE_DEVICE_TABLE(i2c, gt9897_i2c_id_table);

static struct i2c_driver gT9897_i2c_driver = {
	.driver = {
		.name = TS_DRIVER_NAME,
		//.owner = THIS_MODULE,
		.of_match_table = of_match_ptr(gt9897_i2c_matchs),
	},
	.probe = goodix_i2c_probe,
	.remove = goodix_i2c_remove,
	.id_table = gt9897_i2c_id_table,
};

static unsigned long gt9897_i2c_flags;
enum GT9897_I2C_FLAGS {
	GT9897_I2C_INIT = BIT(0),
	GT9897_I2C_CORE_INIT = BIT(1),
	GT9897_I2C_TOOLS_INIT = BIT(2),
	GT9897_I2C_GESTURE_INIT = BIT(3)
};

int goodix_gt9897_i2c_init(void)
{
	if (i2c_add_driver(&gT9897_i2c_driver))
		return -1;

	gt9897_i2c_flags |= GT9897_I2C_INIT;
	if (gt9897_ts_core_init())
		return -1;

	gt9897_i2c_flags |= GT9897_I2C_CORE_INIT;
	if (gt9897_tools_init())
		return -1;

	gt9897_i2c_flags |= GT9897_I2C_TOOLS_INIT;
	if (gt9897_gsx_gesture_init())
		return -1;

	gt9897_i2c_flags |= GT9897_I2C_GESTURE_INIT;

	return 0;
}

void goodix_gt9897_i2c_exit(void)
{
	if (gt9897_i2c_flags & GT9897_I2C_GESTURE_INIT)
		gt9897_gsx_gesture_exit();

	if (gt9897_i2c_flags & GT9897_I2C_TOOLS_INIT)
		gt9897_tools_exit();

	if (gt9897_i2c_flags & GT9897_I2C_CORE_INIT)
		gt9897_ts_core_exit();

	if (gt9897_i2c_flags & GT9897_I2C_INIT)
		i2c_del_driver(&gT9897_i2c_driver);
}

static const int ic_number[1] = {VTS_IC_GT9897_I2C};
module_vts_driver(goodix_gt9897_i2c, ic_number, goodix_gt9897_i2c_init(), goodix_gt9897_i2c_exit());
