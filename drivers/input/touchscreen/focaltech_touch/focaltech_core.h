...
#define ID_G_SPEC_GESTURE_ENABLE_SIGN   0xd1/*bit0-bit5:double click,L,R,U,D*/
#define ID_G_SPEC_GESTURE_ENABLE_CHAR   0xd2/*bit0-bit5:o,e,c,m,w*/
#define ID_G_SPEC_GESTURE_ID            0xd3/*register id*/

#define ID_G_SPEC_GESTURE_EXPORT_ENABLE_A   0xd6
#define ID_G_SPEC_GESTURE_EXPORT_ENABLE_F   0xd8
...
extern struct fts_gesture_st fts_gesture_data; /* eleven+ */
